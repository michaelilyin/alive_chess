 ...
 * @author Admin
 */
public class GrandLeaderPrivilegesMessage implements IProtoSerializableRequest, IProtoDeserializable, ICommand {
    private int com_id;

    public GrandLeaderPrivilegesMessage(){com_id = Commands.GRAND_LEADER_PRIVILEGES_MESSAGE;}
    ...
    public void Execute(Object listener) {
        ...
        l.GrandLeaderPrivilegesMessReceived(this);
    }
