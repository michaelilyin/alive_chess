 ...
 * @author Admin
 */
public class GetArmyCastleToKingRequest implements IProtoSerializableRequest {
    private int com_id;

    public GetArmyCastleToKingRequest(){
        com_id = Commands.GET_ARMY_CASTLE_TO_KING_REQUEST;
    }
