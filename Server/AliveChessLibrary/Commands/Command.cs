namespace AliveChessLibrary.Commands
{
    public enum Command
    {
        ...
        CollectUnitsRequest = 78,
        CollectUnitsResponce = 79,
        GetBuildingsRequest  = 80,
        GetBuildingsResponse = 81,
        GetBuildingCostRequest     = 82,
        GetBuildingCostResponse    = 83,
        GetCastleArmyRequest      = 84,
        GetCastleArmyResponse     = 90,
        GetKingArmyRequest        = 85,
        GetKingArmyResponse       = 91,
        CreateBuildingRequest    = 86,
        CreateBuildingResponse   = 87,
        CreateUnitRequest           = 88,
        CreateUnitResponse = 89,
        LeaveUnitsRequest = 90,
