namespace AliveChessLibrary.Commands
{
    public enum Command
    {
        ...
        GetBuildingsRequest  = 79,
        GetBuildingsResponse = 80,
        GetCreationRequirementsRequest     = 81,
        GetCreationRequirementsResponse    = 82,
        CreateBuildingRequest    = 83,
        CreateBuildingResponse   = 84,
        DestroyBuildingRequest = 85,
        DestroyBuildingResponse = 86,
        CreateUnitRequest = 87,
        CreateUnitResponse = 88,
        CancelUnitRecruitingRequest = 89,
        CancelUnitRecruitingResponse = 90,
        GetProductionQueueRequest = 91,
        GetProductionQueueResponse = 92,
        GetKingArmyRequest        = 93,
        GetKingArmyResponse       = 94,
        GetCastleArmyRequest      = 95,
        GetCastleArmyResponse     = 96,
        CollectUnitsRequest = 97,
        CollectUnitsResponce = 98,
        LeaveUnitsRequest = 99,
        LeaveUnitsResponce = 100,
