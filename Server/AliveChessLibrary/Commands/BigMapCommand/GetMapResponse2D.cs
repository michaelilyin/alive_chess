...
{
    [ProtoContract]
    public class GetMapResponse2D : ICommand
    {
        [ProtoMember(1)]
        private int mapId;
        [ProtoMember(2)]
        ...
        public GetMapResponse2D()
        {
        }

        public GetMapResponse2D(int mapId, int sizeX, int sizeY, List<MapPoint> points,
        ...
        {
            get { return Command.GetMapResponse2D; }
        }
