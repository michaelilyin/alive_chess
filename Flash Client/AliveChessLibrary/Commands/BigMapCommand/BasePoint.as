...
package AliveChessLibrary.Commands.BigMapCommand {
  ...
  public final class BasePoint extends Message {
    public function BasePoint() {
      ...
      registerField("LandscapePointType","",Descriptor.ENUM,Descriptor.LABEL_OPTIONAL,4);
    ...
    // optional .AliveChessLibrary.Commands.BigMapCommand.LandscapeTypes _landscapePointType = 4;
