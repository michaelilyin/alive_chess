...
using AliveChessClient.NetLayer.Executors;
using AliveChessClient.NetLayer.Executors.BigMapExecutors;
using AliveChessClient.NetLayer.Executors.DialogExecutors;
using AliveChessClient.NetLayer.Executors.EmpireExecutors;
...
namespace AliveChessClient.NetLayer.Main
{
    public class MainExecutor
    {
        ...
        public MainExecutor(CommandPool theCommandPool, SocketTransport theTransport, Game game)
        {
            ...
            AuthorizeExecutor authExec = new AuthorizeExecutor(game);
            authExec.AuthorizeEvent += new AuthorizeExecutor.AuthorizeHandler(game.StartForm.EnterToGame);
            executors.Add("AuthorizeResponseExecutor", authExec);
            ...
            executors.Add("MoveUnitResponseExecutor", new MoveUnitResponseExecutor(game));
