...
namespace AliveChessServer.LogicLayer.Environment
{
    ...
    public class Store
    {
        ...
        public void AddResource(Resource resource)
        {
            ...
            lock (_resourceStoreSync)
                store = _resourceStore.FindElement(x => !x.IsFull);
            if (store != null) store.AddResourceToRepository(resource);
        ...
        public void AddFigure(Unit unit)
        {
            ...
            lock (_figireStoreSync)
                store = _figureStore.FindElement(x => !x.IsFull);
        ...
        {
            lock (_figireStoreSync)
                return _figureStore.FindElement(predicate);
        }
        ...
        {
            lock (_resourceStoreSync)
                return _resourceStore.FindElement(predicate);
        }
